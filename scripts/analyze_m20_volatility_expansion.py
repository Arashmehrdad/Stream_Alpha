"""Operator helper for research-only M20 volatility-expansion diagnostics."""
...
def main() -> None:
    """Run M20 volatility-expansion research diagnostics."""
    parser = argparse.ArgumentParser(description="Analyze M20 volatility-expansion setups")
    parser.add_argument("--base-run-dir", required=True)
    parser.add_argument("--json", action="store_true")
    args = parser.parse_args()
    result = analyze_m20_volatility_expansion(base_run_dir=Path(args.base_run_dir))
    if args.json:
