"""Operator helper for M20 v2 refinement planning."""
...
from app.training.m20_v2_refinement_plan import DEFAULT_OUTPUT_NAME, plan_m20_v2_refinement


def main() -> None:
    """Write M20 v2 refinement-plan artifacts."""
    parser = argparse.ArgumentParser(description="Plan M20 v2 strategy refinement")
    parser.add_argument("--source-run-dir", required=True)
    parser.add_argument("--candidate-factory-dir")
    parser.add_argument("--output-name", default=DEFAULT_OUTPUT_NAME)
    parser.add_argument("--json", action="store_true")
    args = parser.parse_args()
    result = plan_m20_v2_refinement(
