"""Deterministic artifact writers for the Stream Alpha M21 continual learning layer."""
...
def ensure_continual_learning_artifact_root(root_dir: str | Path) -> Path:
    """Create and return the canonical continual-learning artifact root."""
    path = Path(root_dir)
